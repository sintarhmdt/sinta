<body style="background-color: #bdecb6;">
  <div id="app">
    <div class="main-wrapper" style="background-color:#bdecb6;">
      ...
      <div class="main-sidebar" style="background-color: #cff0cc;">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="index.html">NGANGKUT YUK!</a>
          </div>
          <div class="sidebar-brand sidebar-brand-sm" style="background-color: #cff0cc;">
