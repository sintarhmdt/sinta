          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <select name="kenek" id="" class="form-control">
                  <option <?php if($mb->kenek == "1"){echo "selected='selected'";} echo $mb->kenek; ?> value="1">Tersedia</option>
                  <option <?php if($mb->kenek == "0"){echo "selected='selected'";} echo $mb->kenek; ?> value="0">Tidak Tersedia</option>
                </select>
                <?= form_error('kenek', '<div class="text-small text-danger">', '</div>') ?>
              </div>
                  </div>
