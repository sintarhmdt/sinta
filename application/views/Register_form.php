      ...
      <div class="container mt-2">
        <div class="row">
          <div class="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-8 offset-lg-2 col-xl-8 offset-xl-2">
            ...
            <center><img src="<?= base_url('assets/upload/logoo.png')  ?>" alt="image description" style= "width:20%; height:20%;" class="shadow-light rounded-circle"></center>
             </div>
            ...
            <div class="simple-footer">
              Copyright &copy; NgangkutYuk 2019
            </div>
          </div>
        </div>
      </div>
